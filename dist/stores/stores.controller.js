...
let StoresController = class StoresController {
    ...
    async update(id, createStoreDto) {
        return await this.storesService.update(id, createStoreDto);
    }
    async addNew(createStoreDto) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StoresController.prototype, "getOneStore", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, stores_entity_1.StoreEntity]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [stores_entity_1.StoreEntity]),
    __metadata("design:returntype", Promise)
], StoresController.prototype, "addNew", null);
__decorate([
    (0, common_1.Delete)('deleteStore/:id'),
    __param(0, (0, common_1.Param)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
