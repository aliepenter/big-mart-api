...
let ProductsController = class ProductsController {
    ...
    async update(id, createProductDto) {
        return await this.productsService.update(id, createProductDto);
    }
    async addNew(createProductDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, products_entity_1.ProductEntity]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [products_entity_1.ProductEntity]),
    __metadata("design:returntype", Promise)
], ProductsController.prototype, "addNew", null);
__decorate([
